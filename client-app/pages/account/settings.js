            ...
            <div className="border p-5 w-1/2">
                ...
                <form onSubmit={handleSubmit}>
                    <div className="mb-5">
                        ...
                        <div className="mt-3">
                            <input type="text" value={ user.username || '' } onChange={handleChange} placeholder="@username" id="username" name="username" className="input input-bordered w-full max-w-xs" />
                        </div>
                    </div>
                    <div className="mb-5">
                    ...
                    <div className="mb-5">
                        ...
                        <div className="mt-3">
                            <input type="email" placeholder="name@email.com" onChange={handleChange} value={ user.email || '' }  id="email" name="email" className="input input-bordered w-full max-w-xs" />
                        </div>
                    </div>
