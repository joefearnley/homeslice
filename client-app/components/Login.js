                ...
                <form className="w-full max-w-xl rounded-lg bg-white p-6">
                    <div className="-mx-3 mb-6 flex flex-wrap">
                        <div className="mb-6 w-full px-3 md:w-full">
                            <label className="mb-2 block text-xs font-bold tracking-wide text-gray-700" for="Password">Email address
                        ...
                        <div className="mb-6 w-full px-3 md:w-full">
                            <label className="mb-2 block text-xs font-bold tracking-wide text-gray-700" for="Password">Password
                        ...
                        <div className="mb-3 flex w-full items-center justify-between px-3">
                            <label for="remember" className="flex w-1/2 items-center cursor-pointer">
